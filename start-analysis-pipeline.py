...
from dataAnalysis.collaborationanlysis import CollaborationAnalysis
from dataHarvesting.dataaquestion import DataAquestion
from dataAnalysis.networkAnalysisForPoster import NetworkAnalysis
from nlpServices.stanfordNER import StanfordNER
from nlpServices.textAnalysis import TextAnalysis
...
if len(sys.argv) >= 7:
    ...
    #dataAquestion.harvestDatasets(4785)#2612

    """ TextAnalysis"""
    #textanalysis.analyze(startFrom)
    #textanalysis.analyze(0)

    """in case stanford NER is used we might run the 3Gram refinments on the whole dataset"""
